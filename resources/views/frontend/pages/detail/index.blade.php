                    ...
                    <div class="sticky-content-inner">
                        ...
                        <div class="ad--space pd--20-0-40">
                            <a
                                ...
                                <img src="{{ asset('frontend/img/ads-img/728X90_banner2.png') }}" alt=""
                                    class="center-block">
                            </a>
                        </div>
                        <!-- Advertisement End -->
                                        ...
                                        <li>
                                            ...
                                            <div class="comment--item clearfix">
                                                <div class="comment--img float--left">
                                                    <img src="{{ asset('frontned') }}/img/news-single-img/comment-avatar-02.jpg" alt="">
                                                </div>
                ...
                <div class="main--sidebar col-md-4 ptop--30 pbottom--30" data-sticky-content="true">
                    <div class="sticky-content-inner">
                        ...
                        <div class="widget">
                            ...
                            <div class="ad--widget">
                                <a href="https://mwc.com.vn/products/giay-sandal-nu-mwc-nusd--2887?c=N%C3%82U">
                                    <img src="{{ asset('frontend/img/ads-img/300x250_banner_mwc.jpg') }}" alt="">
                                </a>
                            </div>
                            <!-- Ad Widget End -->
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a href="https://docbao.qdnd.vn/readding">
                                            <img src="{{ asset('frontend/img/ads-img/150x150_banner_baoin.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <a href="https://baomoi.com/chu-tich-ho-chi-minh/top/114.epi">
                                            <img src="{{ asset('frontend/img/ads-img/150x150_banner_hcm_02-min.png') }}"
                                                alt="">
                                        </a>
                                    </div>
                                </div>
